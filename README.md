# XMC&trade; MCU: SPI master

This code example demonstrates the transfer of three bytes of data using the SPI master in XMC&trade; MCU. The successful completion of transfer is indicated by the toggling of an LED on the board.
...
The following example will clone the "[SPI MASTER](https://github.com/Infineon/mtb-example-xmc-spi-master)" application with the desired name "MySPIMASTER" configured for the *KIT_XMC14_BOOT_001* BSP into the specified working directory, *C:/mtb_projects*:
...
Document title: *CE232739* - *XMC&trade; MCU: SPI master*
